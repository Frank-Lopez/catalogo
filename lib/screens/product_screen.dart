...
import 'package:recetario/provider/product_form_provider.dart';
              ...
              Positioned(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () async {
                      ...
                      print('tenemos jmagen ${pikedFile.path}');
                      productsService.updateSelectedProductImage(pikedFile.path);
                    },
                  ))
            ],
          ),
